...
import { PRODUCTS_CATALOG, Product } from "@/data/siteData";
...
function ProductsContent() {
  ...
  const filteredProducts = useMemo(() => {
    return PRODUCTS_CATALOG.filter((product) => {
      ...
      // Price match (minPrice and maxPrice)
                  ...
                  >
                    <Link href={productUrl} className="block relative w-full h-64 bg-[#F6F6F6] p-4 overflow-hidden">
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 z-10 w-8 h-8 rounded-full bg-white/80 backdrop-blur-sm shadow flex items-center justify-center hover:bg-white transition-all"
                      >
                        <Heart
                          className={`w-4 h-4 ${
                    ...
                    <div className="p-4 bg-white space-y-2 border-t border-[#F0EDE6]">
                      ...
                      <Link
                        href={productUrl}
                        className="w-full mt-3 bg-[#FAF8F5] hover:bg-[#C8232A] text-[#1A1A1A] hover:text-white border border-[#E8E3DA] hover:border-[#C8232A] font-semibold text-xs py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 transition-all"
                      >
